...
CREATE TABLE EMP_INC_RUN_PROC_INFO AS
	...
	or arr.algrunid IN (6258, 6278, 6338, 6318, 6378, 8119, 8880, 8900,17200,17180))
...
select distinct algrunid, exp_run_time, iternum from EMP_INC_RUN_CUTOFF_Info order by exp_run_time, iternum
