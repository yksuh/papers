...
We applied EMPv5 to the data described in Table~\ref{tab:exp_notes1}, to get the following histograms.
...
\begin{figure}[hp!]
	...
	\subfigure[PT frequency on INC2048]{
		...
		\label{fig:inc2048_pt_hist_v5}
	}
	\subfigure[PT frequency on INC4096]{
		\includegraphics[scale=0.43]{4096_sec_pt_hist_v5.eps}
		\label{fig:inc4096_pt_hist_v5}
	}
	\subfigure[PT frequency on INC8192]{
		\includegraphics[scale=0.43]{8192_sec_pt_hist_v5.eps}
		\label{fig:inc8192_pt_hist_v5}
	}
	\subfigure[PT frequency on INC16384]{
		\includegraphics[scale=0.43]{16384_sec_pt_hist_v5.eps}
		\label{fig:inc16384_pt_hist_v5}
	}
