...
ymax <- ceiling(ymax/100)*100
binsize=1
plot(h, freq=TRUE,ylim=c(0,ymax), xlim=c(xmin-2,xmax+2),col="blue", main='ET frequency on INC2', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
#xaxtl <- seq(xmin-1,xmax+1,by=1)
#axis(side=1, at=xaxtl, labels=xaxtl)
...
ymax <- ceiling(ymax/100)*100
binsize=1
plot(h, freq=TRUE,ylim=c(0,ymax), xlim=c(xmin-5,xmax+5),col="blue", main='ET frequency on INC4', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
dev.off()
...
h = hist(x$METIME, right=F,breaks=nbins,plot=F)
ymax <- 40
plot(h, freq=TRUE,ylim=c(0,ymax), xlim=c(xmin,xmax+5000),col="blue", main='ET frequency on INC16384', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), 
xlab='ET (ms)', ylab=expression('Frequency'))
dev.off()
