x = read.csv(file="result_summary/2_sec.dat",head=TRUE,sep="\t")
setEPS()
postscript("result_summary/2_sec_et_all.eps")
plot(x$METIME, xlim=c(0,1000), pch=19, main='', xlab='# of executions', ylab='ET (ms)')
dev.off()
setEPS()
hist.data = hist(x$METIME, breaks = 100, plot=F)
postscript("result_summary/2_sec_et_hist.eps")
