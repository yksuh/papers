...
xmin <-xmin-17
xmax <-xmax+15
plot(h, ylim=c(0,10), xaxt='n',freq=TRUE,xlim=c(xmin,xmax),col="green", main='PT frequency on INC8192', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), xlab='PT (ms)', ylab=expression('Frequency'))
xaxtl <- seq(xmin,xmax,by=binsize)
axis(side=1, at=xaxtl, labels=xaxtl)
dev.off()
...
plot(h, ylim=c(0,60), xaxt='n',freq=TRUE,xlim=c(xmin,xmax),col="green", main='PT frequency on INC8192 in Nov 2015', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), xlab='PT (ms)', ylab=expression('Frequency'))
xaxtl <- seq(xmin,xmax,by=binsize)
axis(side=1, at=xaxtl, labels=xaxtl)
dev.off()
...
x <- subset(x, x$ITERNUM <= 40)
x <- subset(x, x$ITERNUM != 10 & x$ITERNUM != 16)
x_up = mean(x$PRTIME) + 2*sd(x$PRTIME)
x_dn = mean(x$PRTIME) - 2*sd(x$PRTIME)
x = subset(x, x$PRTIME >= x_dn & x$PRTIME <= x_up)
xmax <- max(x$PRTIME)
...
xmin <-xmin-57
xmax <-xmax+45
plot(h, ylim=c(0,15), xaxt='n',freq=TRUE,xlim=c(xmin,xmax),col="green", main='PT frequency on INC16384', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), xlab='PT (ms)', ylab=expression('Frequency'))
xaxtl <- seq(xmin,xmax,by=binsize)
axis(side=1, at=xaxtl, labels=xaxtl)
dev.off()
...
plot(h, ylim=c(0,50), xaxt='n',freq=TRUE,xlim=c(xmin,xmax),col="green", main='PT frequency on INC16384 in Nov 2015', 
sub=paste("(n=",nrow(x),", bin_size=",binsize,"ms)",sep=""), xlab='PT (ms)', ylab=expression('Frequency'))
xaxtl <- seq(xmin,xmax,by=binsize)
axis(side=1, at=xaxtl, labels=xaxtl)
dev.off()
