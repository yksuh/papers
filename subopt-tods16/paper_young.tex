...
\item We show that the hypothesized interactions are \todo{Rick:check after Sabah} supported,
...
\todo{Sabah: update after filling out Table II:}As can
...
\todo{Sabah: revisit this entire section, with confirmatory analysis numbers}
...
Repeats& {\bf H7a:}  & --- & {\bf H5:}  & ---\\
CEPS &  {\bf H7b:} 0. & {\bf H4b:} &  --- &{\bf H4a:}  \\
...
\begin{table}[t]
\tbl{Testing Hypothesis 6: Interaction Strength on the Confirmatory Study\label{tab:hyptest8}}{%
%\begin{center}
\resizebox{85mm}{!}{
...
\todo{Sabah: update with final results:}
...
%\begin{center}
\begin{tabular}{c|c|c|c|c}
{\em Generation}&{\em Number of} &{\em Average}&{\em Cumulative}&{\em Net Cumulative}\\
& {\em Change Points} & {\em Relative Delta} & {\em Relative Delta}& {\em Relative Delta}\\
\hline
1 & --- & --- & 0.00&---\\
2 & --- & --- & 0.00&---\\
3 & --- & --- & 0.00&---\\
4 & 2 & 0.2 & 0.2&-0.24\\
5 & 211 & 0.076 & 0.077&-0.045\\
6 & 86 & 0.16 & 0.102&-0.103\\
7 & 263 & 0.303 & 0.196&-0.0800\\
8 & 273 & 0.303 & 0.231&-0.0256\\
9 & 3 & 0.04 & 0.230&-0.0257\\
10 & 168 & 0.319 & 0.245&0.008\\
11 & 639 & 0.237 & 0.242&0.0296\\
12 & 53 & 0.35 & 0.245&0.0346\\
13 & 12 & 0.40 & 0.246&0.0360\\
...
\todo{Rick: I (Young) updated the following. Please review it.}
