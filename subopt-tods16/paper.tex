...
the number of correlation names, number of aggregates, and presence of a subquery (all measures of query complexity), providing
...
improvements of these optimizers. We articulate for the first time a
possible upper bound on the number of operators a DBMS may be able to support.
...
experiment was very fast.)\todo{Sabah:were any additional discontinuous
  operators found? Rick: Yes, I think they were. like {\tt eq\_ref} on MySQL. But for more details 
I redirect this question to Sabah.}
...
protocol.\todo{Sabah:didn't we also check discontinuity once more? If so,
  were any new discontinuous operators found in this third Exhaustive experiment?}
...
\hline
Presence of subquery & -- & {\bf H2j:} {\em NS} & {\bf H2k:} 0.26 & {\bf H2l:} 0.20\\
\hline
Skew & {\bf H3:} -0.05 & --- & ---  & ---\\
\hline
Repeats& {\bf H6a:} 0.62 & --- & --  & ---\\
...
\hline
Presence of aggregate  & 0.04 & {\em NS} & 0.12 & {\em NS} & 0.31 & 0.22 \\
\hline
Presence of subquery  & 0.03 & {\em NS} & 0.18 & 0.17  & 0.14 & 0.13\\
\end{tabular}
}
%\end{center}
%}
...
qualitatively confirming what was informally articulated but never
coherently tested.
...
%\todo{Young: get citations to show up as Name, year}
%\vfill\pagebreak
%
...
\bibitem{Bellamkonda13} S.~Bellamkonda, H.-G.~Li, U.~Jagtop, Y.~Zhu,
V.~Liang, and T.~Cruanes, ``Adaptive and big data scale parallel execution
in Oracle,'' {\em PVLDB} 6(11):1102--1113, 2013.
