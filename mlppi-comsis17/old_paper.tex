...
\authorlist{% fill arguments of \authorentry, otherwise error will be caused. 
 ...
 %\authorentry{Ahmad GHAZAL}{n}{labelB}
 \authorentry{Alain CROLOTTE}{n}{labelC}
 \authorentry{Pekka KOSTAMAA}{n}{labelC}
...
\affiliate[labelA]{Korea Inst. of Sci. and Tech. Info. (KISTI), 245 Daehangno, Yuseong-gu, Daejeon, Korea, 34141}
%\affiliate[labelB]{Oracle Endeca, Cambridge, MA 02142, USA}
\affiliate[labelC]{Teradata Corporation, El Segundo, CA 90245, USA}
...
%{\# avg. range pairs compared per iteration} 	   & 31.5 & 76.0 & 24 & 48 \\ \hline
%{\# max. range pairs compared within an iteration} & 38 & 103 & 24 & 48 \\ \hline
%{\# min. range pairs compared within an iteration} & 25 & 49 & N/A & N/A\\ \hline
%{\# max. API Calls made per range pair} 		   & 4.92 & 16.14 & & \\ \hline
%{\# min. API Calls made per range pair} 		   & 1.92 & & & \\ \hline
%{\# avg. API calls made per iteration}		 	   & 93.21 & 580 & 78 & 388 \\ \hline
%{\# max. API calls made within an iteration} 	   & 123 & 791 & 78 & 388 \\ \hline
%{\# min. API calls made within an iteration} 	   & 73 & 381 & N/A & N/A \\ \hline
\end{tabular}
}
\end{center}
\end{table*}
...
\profile[yksuh.eps]{Young-Kyoon Suh}{
received MS and PhD degrees in \hbox{computer science} from KAIST, Korea, and the University of \hbox{Arizona}, USA, in 2005 and 2015, respectively. 
He is a senior researcher at KISTI. His research interests include database \hbox{design} and \hbox{systems}, 
science of databases, and big data management.}

%\profile[ahmad.eps]{Ahmad Ghazal}
%{received the PhD degree in computer science from Univ. of Illinois at Chicago.  
%He is now at \hbox{Oracle} Endeca. He is a well-known industry expert in query optimization theory and practice. 
%%He peer-reviewed submissions to the Journal of Systems and Software, IEEE TKDE and DOLAP. 
%His research interest lies in query optimization, big data systems, and physical database design.}

\vspace{-.2in}

\profile[alain.eps]{Alain Crolette}
...
\profile[pekka.eps]{Pekka Kostamaa}
