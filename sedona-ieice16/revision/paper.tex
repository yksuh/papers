...
with a ``long'' program time (in this case, 4.5 hours), some of those daemons are now frequent, and appear in the central cluster.
...
employing process time and identifying an infrequent, long-running daemon}, 
which is more precise and \hbox{accurate} than the traditional method relying on elapsed time\shorten{
as shown in the experiments}.
