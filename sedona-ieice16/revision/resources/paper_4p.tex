...
\shorten{Finally, we conclude this letter.}
}
...
of PT \shorten{(process time, note the switch in emphasis from elapsed time 
...
hours). 
%Four others ({\tt flush-9:0}, {\tt jbd2/md0-8}, 
...
{\color{blue}Four others all occur together and have a periodicity of about every 559 samples 
(5x longer, or just about 20 hours)}. 
...
pairs of two successive samples of PUT128 and PUT16384}.\shorten{: 
...
%  {\tt rhsmcertd-worke}, and {\tt sshd}. 
That said, the central cluster also contains other
  processes not seen in the \hbox{dual-PUT256} central cluster{\color{blue}, 
  such as {\tt grep}, {\tt rhn\_check}, etc.}
...
\begin{tabular}{|p{0.1cm}|R{1.1cm}|R{1.1cm}|R{0.6cm}|R{0.6cm}|R{0.97cm}|R{0.97cm}|} \hline
 		  & \multicolumn{2}{c|}{{\tiny Execution Time (ms)}} & \multicolumn{2}{c|}{{\tiny Standard}}   & \multicolumn{2}{c|}{\multirow{2}{*}{{\tiny Relative}}}\\ \cline{2-3}
 & \multicolumn{1}{c|}{{\tiny{ORG}}}  & \multicolumn{1}{c|}{{\tiny{SED.}}} & \multicolumn{2}{c|}{{\tiny Deviation (ms)}}  & \multicolumn{2}{c|}{{\tiny Error}}\\ \cline{4-7}	
